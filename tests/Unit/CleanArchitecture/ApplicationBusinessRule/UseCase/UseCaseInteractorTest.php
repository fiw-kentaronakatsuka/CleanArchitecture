...
{
    public function test_exec_正常なInputAccessDataが生成されることを確認()
    {
        //  arrange
        ...
        $expected = new InputAccessData(1, false);

        //  act
        $useCaseInteractor->exec($inputData);
        $actual = $useCaseInteractor->getInputAccessData();
    ...
    public function test_exec_正常なOutputDataが生成されることを確認()
    {
        ...
        $dataAccessStub->method('exec')
            ->willReturn(new OutputAccessData(1, 'test_name', 500001));
